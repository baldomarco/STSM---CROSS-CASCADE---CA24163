...
con <- dbConnect(SQLite(), dbname = "C:/iLand/2023/20230914_plot_experiment/_project/database/db_clim_cz_plot.sqlite")
...
csv_file <- "C:/iLand/2023/20230914_plot_experiment/_project/database/climate_data_synthesis.csv"
...
#--------------------------
DWP<- read_excel("C:/iLand/2023/CZ_JH1_C_pools_99_plots.xlsx")
...
basic<-"C:/Users/baldo/Documents/GitHub/Bottoms-Up/Synthesis_of_Multi-Taxon_Forest_Plots_in_the_iLand_Model/Project_files/2022_Artifical_bottom_L1_10.xml"
data<- read_xml(basic)
d<-as_list(data)
...
project.files.to.put<-"C:/Users/baldo/Documents/GitHub/Bottoms-Up/Synthesis_of_Multi-Taxon_Forest_Plots_in_the_iLand_Model/Project_files/project_files/New folder/"
...
homeroot<-"C:/iLand/2023/20230914_plot_experiment/_project/"     # this is the ssd disk, homeroot where the model is run and the outputs are produced

ROOT<-"C:/iLand/2023/20230914_plot_experiment/_project/"         # this supposed to be the mounted disk
...
for (i in 1:n) {
  ...
  write_xml(p, out, options = c("format", "no_declaration"))
  d2 <- read_xml(out)
  write_xml(d2, out, options = "format")
